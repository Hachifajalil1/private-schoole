...
fun TimetableStudentsParents(innerPadding: PaddingValues) {
    ...
    if (userId != null) {
        ...
        Text(text = "No user ID found", style = MaterialTheme.typography.labelMedium, modifier = Modifier.padding(innerPadding))
    }
}

suspend fun fetchStudentsByParentId(parentId: String): Map<String, String> {
    ...
    for (studentSnapshot in studentsSnapshot.children) {
        ...
        if (studentId != null && studentParentId == parentId && studentName != null && studentFamilyName != null) {
                ...
                items(students.toList()) { (studentId, studentName) ->
                    Card(
                        ...
                        Row(
                            ...
                            Text(text = studentId, modifier = Modifier.weight(1f), style = MaterialTheme.typography.labelMedium, color = MaterialTheme.colorScheme.primary)
                        }
                    }
                }
            }
